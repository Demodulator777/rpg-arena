...
function buildExtendedAchievements() {
    ...
    extras.push(
    {
        ...
        },
        {
            ...
            category: 'combat',
            name: 'First Blood',
            desc: 'Deal 100 total damage in battles.',
            icon: '🩸',
            metric: 'damage_dealt',
            target: 100,
        ...
        },
        {
            ...
            category: 'combat',
            name: 'Skirmisher',
            desc: 'Deal 250 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 250,
            rewards: { gold: 15000, consumable: { id: 'potion_mana', qty: 2 } },
        },
        {
            ...
            category: 'combat',
            name: 'Warrior',
            desc: 'Deal 500 total damage in battles.',
            icon: '🛡️',
            metric: 'damage_dealt',
            target: 500,
            rewards: { gold: 35000, gems: 5, lootbox: { id: 'lootbox_common', qty: 1 } },
        },
        {
        ...
        {
            id: 'damage_dealt_1500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Veteran Duelist',
            desc: 'Deal 1,500 total damage in battles.',
            icon: '🏆',
            metric: 'damage_dealt',
            target: 1500,
            rewards: { gold: 150000, gems: 15, lootbox: { id: 'lootbox_rare', qty: 1 } },
        },
        {
            id: 'damage_dealt_2000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Champion',
            desc: 'Deal 2,000 total damage in battles.',
            icon: '👑',
            metric: 'damage_dealt',
            target: 2000,
            rewards: { gold: 250000, gems: 20, lootbox: { id: 'lootbox_epic', qty: 1 } },
        },
        {
            id: 'damage_dealt_2500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Warlord',
            desc: 'Deal 2,500 total damage in battles.',
            icon: '🏰',
            metric: 'damage_dealt',
            target: 2500,
            rewards: { gold: 350000, gems: 25, lootbox: { id: 'lootbox_epic', qty: 1 } },
        ...
        {
            id: 'damage_dealt_3000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Avatar of War',
            desc: 'Deal 3,000 total damage in battles.',
            icon: '🔥',
            metric: 'damage_dealt',
            target: 3000,
            rewards: { gold: 500000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 }, premium: { id: 'iron_fortress', days: 7 } },
        },
        {
            id: 'damage_dealt_3500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of Carnage',
            desc: 'Deal 3,500 total damage in battles.',
            icon: '🗡️',
            metric: 'damage_dealt',
            target: 3500,
        ...
        {
            id: 'damage_dealt_4000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Slayer',
            desc: 'Deal 4,000 total damage in battles.',
            icon: '💀',
            metric: 'damage_dealt',
            target: 4000,
        ...
        {
            id: 'damage_dealt_4500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Executioner',
            desc: 'Deal 4,500 total damage in battles.',
            icon: '⚰️',
            metric: 'damage_dealt',
            target: 4500,
            rewards: { gold: 800000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_5500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 5,500 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 5500,
            rewards: { gold: 1000000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_6000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Unstoppable Force',
            desc: 'Deal 6,000 total damage in battles.',
            icon: '💥',
            metric: 'damage_dealt',
            target: 6000,
            rewards: { gold: 1100000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_6500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Destroyer',
            desc: 'Deal 6,500 total damage in battles.',
            icon: '🔥',
            metric: 'damage_dealt',
            target: 6500,
            rewards: { gold: 1200000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_7000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Annihilator',
            desc: 'Deal 7,000 total damage in battles.',
            icon: '☠️',
            metric: 'damage_dealt',
            target: 7000,
            rewards: { gold: 1300000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_7500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Titan Slayer',
            desc: 'Deal 7,500 total damage in battles.',
            icon: '🏔️',
            metric: 'damage_dealt',
            target: 7500,
            rewards: { gold: 1400000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_8000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Demigod',
            desc: 'Deal 8,000 total damage in battles.',
            icon: '🌟',
            metric: 'damage_dealt',
            target: 8000,
            rewards: { gold: 1500000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_8500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Avatar of Destruction',
            desc: 'Deal 8,500 total damage in battles.',
            icon: '🌪️',
            metric: 'damage_dealt',
            target: 8500,
            rewards: { gold: 1600000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_9000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of Destruction',
            desc: 'Deal 9,000 total damage in battles.',
            icon: '💀',
            metric: 'damage_dealt',
            target: 9000,
            rewards: { gold: 1700000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_9500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Overlord',
            desc: 'Deal 9,500 total damage in battles.',
            icon: '👑',
            metric: 'damage_dealt',
            target: 9500,
            rewards: { gold: 1800000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_10000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Legendary Destroyer',
            desc: 'Deal 10,000 total damage in battles.',
            icon: '🏆',
            metric: 'damage_dealt',
            target: 10000,
            rewards: { gold: 1900000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_10500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of Destruction',
            desc: 'Deal 10,500 total damage in battles.',
            icon: '💥',
            metric: 'damage_dealt',
            target: 10500,
            rewards: { gold: 2000000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_11000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 11,000 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 11000,
            rewards: { gold: 2100000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_11500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Warrior',
            desc: 'Deal 11,500 total damage in battles.',
            icon: '🏆',
            metric: 'damage_dealt',
            target: 11500,
            rewards: { gold: 2200000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_12000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of War',
            desc: 'Deal 12,000 total damage in battles.',
            icon: '👑',
            metric: 'damage_dealt',
            target: 12000,
            rewards: { gold: 2300000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_12500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 12,500 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 12500,
            rewards: { gold: 2400000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_13000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Destroyer',
            desc: 'Deal 13,000 total damage in battles.',
            icon: '💀',
            metric: 'damage_dealt',
            target: 13000,
            rewards: { gold: 2500000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_13500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of Destruction',
            desc: 'Deal 13,500 total damage in battles.',
            icon: '💥',
            metric: 'damage_dealt',
            target: 13500,
            rewards: { gold: 2600000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_14000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 14,000 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 14000,
            rewards: { gold: 2700000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_14500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Warrior',
            desc: 'Deal 14,500 total damage in battles.',
            icon: '🏆',
            metric: 'damage_dealt',
            target: 14500,
            rewards: { gold: 2800000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            ...
            metric: 'damage_dealt',
            target: 15000,
            rewards: { gold: 2900000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_15500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 15,500 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 15500,
            rewards: { gold: 3000000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_16000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Destroyer',
            desc: 'Deal 16,000 total damage in battles.',
            icon: '💀',
            metric: 'damage_dealt',
            target: 16000,
            rewards: { gold: 3100000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_16500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of Destruction',
            desc: 'Deal 16,500 total damage in battles.',
            icon: '💥',
            metric: 'damage_dealt',
            target: 16500,
            rewards: { gold: 3200000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_17000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 17,000 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 17000,
            rewards: { gold: 3300000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_17500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Warrior',
            desc: 'Deal 17,500 total damage in battles.',
            icon: '🏆',
            metric: 'damage_dealt',
            target: 17500,
            rewards: { gold: 3400000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_18000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of War',
            desc: 'Deal 18,000 total damage in battles.',
            icon: '👑',
            metric: 'damage_dealt',
            target: 18000,
            rewards: { gold: 3500000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        ...
        {
            id: 'damage_dealt_18500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 18,500 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 18500,
            rewards: { gold: 3600000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_19000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Supreme Destroyer',
            desc: 'Deal 19,000 total damage in battles.',
            icon: '💀',
            metric: 'damage_dealt',
            target: 19000,
            rewards: { gold: 3700000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_19500',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'Master of Destruction',
            desc: 'Deal 19,500 total damage in battles.',
            icon: '💥',
            metric: 'damage_dealt',
            target: 19500,
            rewards: { gold: 3800000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
            id: 'damage_dealt_20000',
            chain: 'damage_dealt',
            category: 'combat',
            name: 'God of War',
            desc: 'Deal 20,000 total damage in battles.',
            icon: '⚔️',
            metric: 'damage_dealt',
            target: 20000,
            rewards: { gold: 3900000, gems: 25, lootbox: { id: 'lootbox_legendary', qty: 1 } },
        },
        {
...
if (freshChar.class === 'rogue') {
    ...
    if (!hasShield || shieldIsOffhand) {
        ...
        await dbRun(db, `UPDATE characters SET xp=?,gold=gold+?,gems=gems+?,level=?,wins=?,losses=?,hp_current=?,total_gold_earned=total_gold_earned+?,total_gems_earned=COALESCE(total_gems_earned, 0)+?,mission_gems_earned=COALESCE(mission_gems_earned, 0)+?,damage_dealt=damage_dealt+? WHERE id=?`,
            [newXp, goldEarned, gemsFound, newLevel, newWins, newLosses, finalHp, goldEarned, gemsFound, gemsFound, battle.totalDmgToB || 0, freshChar.id]);
...
router.post('/attack/:targetId', auth, async (req, res) => {
    try {
        ...
        await dbRun(db, `UPDATE characters SET xp=?,gold=MAX(0,gold+?),level=?,wins=wins+?,losses=losses+?,draws=draws+?,hp_current=?,total_gold_earned=total_gold_earned+?,total_gold_lost=total_gold_lost+?,damage_dealt=damage_dealt+? WHERE id=?`,
            [atkXp, goldGained, atkLevel, attackerWon?1:0, attackerWon?0:1, isDraw?1:0, atkFinalHp, goldGained>0?goldGained:0, goldGained<0?-goldGained:0, battle.totalDmgToB || 0, freshA.id]);
        await handleReferralLevelMilestone(db, freshA.user_id, freshA.level, atkLevel);
        await dbRun(db, `UPDATE characters SET gold=MAX(0,gold+?),wins=wins+?,losses=losses+?,draws=draws+?,hp_current=?,total_gold_earned=total_gold_earned+?,total_gold_lost=total_gold_lost+?,damage_dealt=damage_dealt+? WHERE id=?`,
            [defGoldChange, attackerWon?0:1, attackerWon?1:0, isDraw?1:0, newHpD, defGoldChange>0?defGoldChange:0, defGoldChange<0?-defGoldChange:0, battle.totalDmgToA || 0, freshD.id]);
        try {
