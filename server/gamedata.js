...
const EQUIPMENT_RECIPES = [
    ...
    // ══════════════════════════════════════════════
    //  SET 1 — IRONCLAD  (Swamp, Lv5+)  quality: epic
    //  Tank — max physical defence, armor, HP
    // ══════════════════════════════════════════════
    {
        id:'ironclad_weapon', setId:'ironclad', setPiece:'weapon',
        name:'Ironclad Warhammer', emoji:'🔨', quality:'epic', tier:3,
        slot:'weapon', level:5,
    ...
    },
    {
        ...
        name:'Ironclad Plate', emoji:'🛡️', quality:'epic', tier:3,
        slot:'armor', level:5,
    ...
    },
    {
        ...
        name:'Ironclad Greathelm', emoji:'⛑️', quality:'epic', tier:3,
        slot:'helmet', level:5,
    ...
    },
    {
        ...
        name:'Ironclad Tower Shield', emoji:'🔰', quality:'epic', tier:3,
        slot:'shield', level:5,
    ...
    },
    {
        ...
        name:'Ironclad Sabatons', emoji:'👢', quality:'epic', tier:3,
        slot:'boots', level:5,
    ...
    // ══════════════════════════════════════════════
    //  SET 2 — SENTINEL  (Mountains, Lv12+)  quality: epic
    //  Balanced — hit/crit chance, elemental resist
    // ══════════════════════════════════════════════
    {
        id:'sentinel_weapon', setId:'sentinel', setPiece:'weapon',
        name:'Sentinel Spear', emoji:'⚔️', quality:'epic', tier:4,
        slot:'weapon', level:12,
    ...
    },
    {
        ...
        name:'Sentinel Chainmail', emoji:'🧥', quality:'epic', tier:4,
        slot:'armor', level:12,
    ...
    },
    {
        ...
        name:'Sentinel Visor', emoji:'🪖', quality:'epic', tier:4,
        slot:'helmet', level:12,
    ...
    },
    {
        ...
        name:'Sentinel Aegis', emoji:'🛡️', quality:'epic', tier:4,
        slot:'shield', level:12,
    ...
    },
    {
        ...
        name:'Sentinel Greaves', emoji:'🥾', quality:'epic', tier:4,
        slot:'boots', level:12,
    ...
    // ══════════════════════════════════════════════
    //  SET 3 — VOIDBORN  (Ruins/Dark City, Lv22+)  quality: legendary
    //  Magic attacker — elemental devastation + all-resist
    // ══════════════════════════════════════════════
    {
        id:'voidborn_weapon', setId:'voidborn', setPiece:'weapon',
        name:'Voidborn Scythe', emoji:'🪄', quality:'legendary', tier:5,
        slot:'weapon', level:22,
    ...
    },
    {
        ...
        name:'Voidborn Robes', emoji:'🌑', quality:'legendary', tier:5,
        slot:'armor', level:22,
    ...
    },
    {
        ...
        name:'Voidborn Crown', emoji:'👑', quality:'legendary', tier:5,
        slot:'helmet', level:22,
    ...
    },
    {
        ...
        name:'Voidborn Bulwark', emoji:'🟣', quality:'legendary', tier:5,
        slot:'shield', level:22,
    ...
    },
    {
        ...
        name:'Voidborn Striders', emoji:'🟤', quality:'legendary', tier:5,
        slot:'boots', level:22,
...
// Add to your POTION_CATALOGUE or create a new LOOT_BOXES array
const LOOT_BOXES = [
    {
        id: 'lootbox_common',
