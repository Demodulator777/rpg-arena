...
stats:{ dmg_min:1, dmg_max:1.5, defense:18, armor:10, agility:7, crit_chance:12, hit_chance:38,
    ...
    // ══════════════════════════════════════════════
    {
        ...
        slot:'weapon', weaponType:'scythe',
        desc:'The obsidian edge hums with the final shriek of a god whose fall carved the Abyss, drinking crimson light to fuel each swing. Increases pyro damage by 5% each round (max 25%).',
