...
weapon: { name: "Malachar's Reaper Blade", emoji: '💀', weaponType: 'scythe', slot: 'weapon', quality: 'legendary',
                ...
                stats:{ dmg_min:34, dmg_max:58, strength:22, hit_chance:10, crit_chance:12, agility:-6 } },
    ...
    ignarath: {
        ...
        pieces: {
            weapon: { name: "Ignarath's Inferno Fang",  emoji: '🔥', weaponType: 'sword', slot: 'weapon', quality: 'legendary',
                ...
                stats:{ dmg_min:30, dmg_max:52, strength:12, pyro_dmg:24, pyro_resist:19,hit_chance:8, crit_chance:9, agility:5, water_resist:-12 } },
            armor:  { name: "Ignarath's Cinderplate",   emoji: '🔥', slot: 'armor', quality: 'legendary',
                ...
                stats:{ defense:40, armor:30, hp_max:500, strength:8, hit_chance:7, crit_chance:5, agility:3, pyro_dmg:14, pyro_resist:20, water_resist:-10 } },
            helmet: { name: "Ignarath's Ember Crown",   emoji: '👑', slot: 'helmet', quality: 'legendary',
                ...
                stats:{ defense:32, armor:24, hp_max:280, pyro_dmg:18, pyro_resist:15, crit_chance:8, hit_chance:8, agility:3 } },
            shield: { name: "Ignarath's Magma Bulwark", emoji: '🛡️', slot: 'shield', quality: 'legendary',
                ...
                stats:{ defense:44, armor:32, hp_max:350, pyro_resist:24, pyro_dmg:10, hit_chance:8, crit_chance:6, agility:3 } },
            boots:  { name: "Ignarath's Ash Striders",  emoji: '👢', slot: 'boots', quality: 'legendary',
                ...
                stats:{ defense:28, armor:16, agility:5, pyro_dmg:12, pyro_resist:20, hit_chance:6, crit_chance:6 } },
        },
    },
...
weapon: { name: "Nyxaroth's Maw Cleaver",   emoji: '🌪️', weaponType: 'axe', slot: 'weapon', quality: 'legendary',
                ...
                stats:{ dmg_min:12, dmg_max:66, agility:28, crit_chance:26, hit_chance:18, defense:-8 } },
...
weapon: { name: "Vizorax's Unholy Scepter", emoji: '👹', weaponType: 'staff', slot: 'weapon', quality: 'legendary',
                ...
                stats:{ dmg_min:18, dmg_max:32, magic:30, hit_chance:10, pyro_dmg:14, water_dmg:14, wind_dmg:14, electro_dmg:14 } },
            armor:  { name: "Vizorax's Living Plate",   emoji: '👹', slot: 'armor', quality: 'legendary',
                ...
                stats:{ armor:30, defense:34, magic:22, hp_max:380, pyro_resist:18, water_resist:18, wind_resist:18, electro_resist:18 } },
            helmet: { name: "Vizorax's Corrupt Crown",  emoji: '👑', slot: 'helmet', quality: 'legendary',
                ...
                stats:{ armor:28,defense:28, magic:20, hp_max:240, pyro_dmg:10, water_dmg:10, wind_dmg:10, electro_dmg:10 } },
            shield: { name: "Vizorax's Sinward",        emoji: '🛡️', slot: 'shield', quality: 'legendary',
                ...
                stats:{ armor:31, defense:40, magic:18, hp_max:320, pyro_resist:22, water_resist:22, wind_resist:22, electro_resist:22 } },
            boots:  { name: "Vizorax's Damned Treads",  emoji: '👢', slot: 'boots', quality: 'legendary',
                ...
                stats:{ armor:28, defense:24, magic:18, agility:6, hit_chance:8, hp_max:160 } },
        },
    },
