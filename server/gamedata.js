...
const COMPONENTS = {
    ...
    dragon_plate:   { name:'Dragon Plate Mat',   emoji:'🛡️', recipe:{ dragon_scale_shard:3, mithril_ore:2 },    goldCost:300,  rarity:'epic'      },
...
weapon: { name: "Malachar's Reaper Blade", emoji: '💀', weaponType: 'scythe', slot: 'weapon', quality: 'legendary',
                desc: 'A spectral scythe that drinks the warmth from every soul it cuts.',
                stats:{ dmg_min:34, dmg_max:58, strength:22, hit_chance:20, crit_chance:12, agility:-6, wind_dmg:13, wind_resist:15 } },
            armor:  { name: "Malachar's Deathplate",   emoji: '🦴', slot: 'armor', quality: 'legendary',
                desc: 'Blackened plate bound with the bones of warriors Malachar has slain.',
                stats:{ defense:28, armor:12, hp_max:400, strength:18, hit_chance:19, crit_chance:9, agility:-4, wind_dmg:13, wind_resist:15 } },
            helmet: { name: "Malachar's Skullveil",    emoji: '👑', slot: 'helmet', quality: 'legendary',
                desc: 'A hollowed helm that whispers the names of the fallen to its wearer.',
                stats:{ defense:24, armor:10, hp_max:220, strength:16, hit_chance:16, crit_chance:10, wind_dmg:13, wind_resist:15 } },
            shield: { name: "Malachar's Soulward",     emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A warden of stolen souls said to scream when blades strike it.',
                stats:{ defense:32, armor:14, hp_max:300, strength:12, hit_chance:18, crit_chance:9, wind_dmg:13, wind_resist:15 } },
            boots:  { name: "Malachar's Bone Striders",emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Treads carved from femur bones, etching runes of undeath with every step.',
                stats:{ defense:20, armor:8, strength:14, hit_chance:19, crit_chance:9, agility:-8, hp_max:180, wind_dmg:13, wind_resist:15 } },
        },
    },
    ...
    ignarath: {
        ...
        pieces: {
            weapon: { name: "Ignarath's Inferno Fang",  emoji: '🔥', weaponType: 'sword', slot: 'weapon', quality: 'legendary',
                desc: 'A living blade that weeps molten cinder and never cools between battles.',
                stats:{ dmg_min:30, dmg_max:52, strength:12, pyro_dmg:24, pyro_resist:19,hit_chance:20, crit_chance:9, agility:5, water_resist:-12 } },
            armor:  { name: "Ignarath's Cinderplate",   emoji: '🔥', slot: 'armor', quality: 'legendary',
                desc: 'Mail forged inside a volcano mouth, yet strangely cold to the touch.',
                stats:{ defense:40, armor:30, hp_max:500, strength:8, hit_chance:17, crit_chance:5, agility:3, pyro_dmg:14, pyro_resist:20, water_resist:-10 } },
            helmet: { name: "Ignarath's Ember Crown",   emoji: '👑', slot: 'helmet', quality: 'legendary',
                desc: 'A crown of smoldering coals that reignites on the eve of war.',
                stats:{ defense:32, armor:24, hp_max:280, pyro_dmg:18, pyro_resist:15, crit_chance:8, hit_chance:18, agility:3 } },
            shield: { name: "Ignarath's Magma Bulwark", emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A slab of crusted magma that hardens into obsidian under fire.',
                stats:{ defense:44, armor:32, hp_max:350, pyro_resist:24, pyro_dmg:10, hit_chance:18, crit_chance:6, agility:3 } },
            boots:  { name: "Ignarath's Ash Striders",  emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Greaves that leave smoldering footprints wherever the wearer walks.',
                stats:{ defense:28, armor:16, agility:5, pyro_dmg:12, pyro_resist:20, hit_chance:16, crit_chance:6 } },
        },
    },
...
weapon: { name: "Nyxaroth's Maw Cleaver",   emoji: '🌪️', weaponType: 'axe', slot: 'weapon', quality: 'legendary',
                desc: 'A serrated axe that hums with hungry wind and bites faster than sight.',
                stats:{ dmg_min:12, dmg_max:57, strength:25, agility:28, crit_chance:26, hit_chance:18, defense:-8, pyro_resist:39 } },
            armor:  { name: "Nyxaroth's Stormhide",     emoji: '🌪️', slot: 'armor', quality: 'legendary',
                desc: 'Cured from the hide of a storm beast, crackling with trapped lightning.',
                stats:{ defense:16, strength: 23, armor:28, hp_max:280, agility:22, crit_chance:18, hit_chance:17, pyro_resist:36 } },
            helmet: { name: "Nyxaroth's Razor Helm",    emoji: '💀', slot: 'helmet', quality: 'legendary',
                desc: 'A sleek mask that sharpens the wearer\'s senses to a blade\'s edge.',
                stats:{ defense:12, strength: 20, armor:26, hp_max:160, agility:20, crit_chance:22, hit_chance:20, pyro_resist:43 } },
            shield: { name: "Nyxaroth's Windward",      emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A gale-bound ward that deflects projectiles before they arrive.',
                stats:{ defense:18, strength: 14, armor:28, hp_max:200, agility:14, crit_chance:16, hit_chance:16, pyro_resist:39 } },
            boots:  { name: "Nyxaroth's Tempest Treads",emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Soles spun from cyclone strands, leaving no footprint behind.',
                stats:{ defense:-6, strength:16, armor:16, agility:34, crit_chance:20, hit_chance:20, pyro_resist:32 } },
        },
    },
...
weapon: { name: "Vizorax's Unholy Scepter", emoji: '👹', weaponType: 'staff', slot: 'weapon', quality: 'legendary',
                desc: 'A corrupted scepter that bends the four elements to its dark will.',
                stats:{ dmg_min:18, dmg_max:32, magic:30, hit_chance:20, crit_chance:15, pyro_dmg:12, pyro_resist:7, water_dmg:12, water_resist:7, wind_dmg:12, wind_resist:7, electro_dmg:12, electro_resist:7 } },
            armor:  { name: "Vizorax's Living Plate",   emoji: '👹', slot: 'armor', quality: 'legendary',
                desc: 'Armor grown from flesh and shadow, absorbing arcane strikes into itself.',
                stats:{ armor:30, defense:34, magic:22, hp_max:380, hit_chance:19, crit_chance:10, pyro_resist:18, water_dmg:12, water_resist:18, wind_resist:18, electro_resist:18 } },
            helmet: { name: "Vizorax's Corrupt Crown",  emoji: '👑', slot: 'helmet', quality: 'legendary',
                desc: 'A crown forged in the depths that lets its wearer see through all spells.',
                stats:{ armor:28,defense:28, magic:20, hp_max:240, hit_chance:18, crit_chance:12,pyro_dmg:10, water_dmg:10, wind_dmg:10, electro_dmg:10 } },
            shield: { name: "Vizorax's Sinward",        emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A ward that has devoured a thousand enemy incantations.',
                stats:{ armor:31, defense:40, magic:18, hp_max:320, hit_chance:21, crit_chance:19, pyro_resist:22, water_resist:22, wind_dmg:12, wind_resist:22, electro_resist:22 } },
            boots:  { name: "Vizorax's Damned Treads",  emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Footwear stitched from shadow, grounding the wearer in unholy power.',
                stats:{ armor:28, defense:24, magic:18, agility:6, hit_chance:18, crit_chance:18,hp_max:160, water_dmg:12, pyro_dmg:12 } },
        },
    },
...
weapon: { name: "Hollow King's Vow Blade",  emoji: '👑', weaponType: 'sword', slot: 'weapon', quality: 'legendary',
                desc: 'A blade sworn to the throne of the drowned, weeping saltwater in battle.',
                stats:{ dmg_min:20, dmg_max:36, magic:20, water_dmg:22, hit_chance:18, crit_chance:12, agility:-4 } },
            armor:  { name: "Hollow King's Regalia",    emoji: '👑', slot: 'armor', quality: 'legendary',
                desc: 'Tide-soaked robes that hold the weight of an entire forgotten ocean.',
                stats:{ defense:56, armor:30, hp_max:800, magic:14, water_dmg:12, water_resist:20, vitality:6, hit_chance:18, crit_chance:13 } },
            helmet: { name: "Hollow King's Empty Crown",emoji: '💀', slot: 'helmet', quality: 'legendary',
                desc: 'A crown that is always full of rain, no matter the hour of day.',
                stats:{ defense:46, armor:24, hp_max:420, magic:16, water_dmg:14, water_resist:20, hit_chance:25, crit_chance:14 } },
            shield: { name: "Hollow King's Crown Ward", emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A ward forged from the king\'s shattered throne, still carrying his decree.',
                stats:{ defense:58, armor:34, hp_max:500, water_dmg:12, water_resist:26, hit_chance:19, crit_chance:12 } },
            boots:  { name: "Hollow King's Dust Treads",emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Greaves from the royal armory, caked in the ashes of his court.',
                stats:{ defense:42, armor:18, magic:12, water_dmg:10, hp_max:260, hit_chance:18, crit_chance:12, agility:6 } },
        },
    },
...
weapon: { name: "Colossus' Void Maul",      emoji: '🗿', weaponType: 'hammer', slot: 'weapon', quality: 'legendary',
                desc: 'A stone maul pulled from a sleeping mountain, impossibly heavy yet obedient.',
                stats:{ dmg_min:14, dmg_max:56, strength:66, defense:40, armor:6, vitality:10, hit_chance:23, crit_chance:21 } },
            armor:  { name: "Colossus' Totemic Plate",  emoji: '🗿', slot: 'armor', quality: 'legendary',
                desc: 'Plate carved with totems of the earth, shrugging off the mightiest blows.',
                stats:{ defense:80, strength:56, armor:83, hp_max:1400, vitality:18, hit_chance:23, crit_chance:21 } },
            helmet: { name: "Colossus' Monolith Helm",  emoji: '🗿', slot: 'helmet', quality: 'legendary',
                desc: 'A helm that weighs a ton, shielding the mind as surely as the skull.',
                stats:{ defense:66, strength:52,armor:76, hp_max:700, vitality:10, hit_chance:23, crit_chance:21 } },
            shield: { name: "Colossus' Stone Bastion",  emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'An unbreakable bulwark that has never once been moved by force.',
                stats:{ defense:78, strength:57, armor:84, hp_max:800, vitality:12, hit_chance:23, crit_chance:21 } },
            boots:  { name: "Colossus' Earth Striders", emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Boots fused with bedrock, anchoring their wearer to the very world.',
                stats:{ defense:62, strength:46, armor:76, hp_max:480, vitality:8, hit_chance:23, crit_chance:21 } },
        },
    },
    ...
    empress: {
        ...
        pieces: {
            weapon: { name: "Empress' Eternal Blade",   emoji: '🌙', weaponType: 'sword', slot: 'weapon', quality: 'legendary',
                desc: 'A blade enchanted to never dull, gleaming with the light of the undying moon.',
            ...
            armor:  { name: "Empress' Twilight Garb",   emoji: '🌙', slot: 'armor', quality: 'legendary',
                desc: 'Silk soaked in moonlight, crackling softly with eternal static.',
                stats:{ defense:44, armor:28, hp_max:600, strength:8, magic:8, electro_dmg:10, electro_resist:16, crit_chance:8, hit_chance:17 } },
            helmet: { name: "Empress' Crescent Diadem", emoji: '👑', slot: 'helmet', quality: 'legendary',
                desc: 'A diadem shaped like a waning crescent, crowning its wearer with calm foresight.',
            ...
            shield: { name: "Empress' Moonlight Ward",  emoji: '🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A ward of pale light that repels all that would harm the royal line.',
                stats:{ defense:48, armor:30, hp_max:420, electro_dmg:14, electro_resist:20, crit_chance:8 } },
            boots:  { name: "Empress' Shadow Slippers", emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Featherlight slippers that let the empress glide through her own shadow.',
                stats:{ defense:34, armor:16, agility:10, electro_dmg:12, hit_chance:12, crit_chance:15 } },
        },
    },
    ...
    abyssal_sovereign: {
        ...
        pieces: {
            weapon: { name: "Sovereign's Abyss Fang",   emoji: '☄️', weaponType: 'sword', slot: 'weapon', quality: 'legendary',
                desc: 'A blade carved from a falling star, always silent and always certain.',
                stats:{ dmg_min:44, dmg_max:48, strength:33, defense:33, magic:12, hit_chance:28, crit_chance:8, agility:6 } },
            armor:  { name: "Sovereign's Void Casque",  emoji: '☄️', slot: 'armor', quality: 'legendary',
                desc: 'Void-steel plate that swallows sound and light around its wearer.',
                stats:{ defense:40, strength:39, magic:10, armor:26, hp_max:520, hit_chance:18, crit_chance:12 } },
            helmet: { name: "Sovereign's Chthonic Crown",emoji: '☄️', slot: 'helmet', quality: 'legendary',
                desc: 'A crown born of the deep places, granting visions of what lies beneath.',
                stats:{ defense:32, strength:28, magic:12, armor:20, hp_max:300, hit_chance:22, crit_chance:9 } },
            shield: { name: "Sovereign's Genesis Warden",emoji:'🛡️', slot: 'shield', quality: 'legendary',
                desc: 'A warden etched with the first words of creation, unmoved by chaos.',
                stats:{ defense:46, strength:40, armor:30, hp_max:360, hit_chance:16, crit_chance:12 } },
            boots:  { name: "Sovereign's Abyss Treads", emoji: '👢', slot: 'boots', quality: 'legendary',
                desc: 'Treads made from the edge of the abyss, stepping apart from fate.',
                stats:{ defense:30, strength:25, magic:8, armor:14, agility:14, hit_chance:20, crit_chance:15 } },
        },
    },
};
