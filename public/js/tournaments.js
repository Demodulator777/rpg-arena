...
function render(char, data) {
  ...
  c.innerHTML = `
    <div class="t-banner">
      <img class="t-banner-img" src="/images/tournaments/banner.png" alt="">
    </div>
    <div style="text-align:center;margin-bottom:24px">
      <div class="tournament-status ${statusClass}">${statusLabel}</div>
      <div class="t-banner-title">${modeLabel}</div>
      <div class="t-banner-sub">${participants.length} ELITE FIGHTERS</div>
    </div>
