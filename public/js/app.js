...
function renderAbyssMap() {
    ...
    const exitButton = showExit ? `
        <div style="position:absolute;left:12%;top:78%;transform:translate(-50%,-50%);cursor:pointer;z-index:10;text-align:center" ${actionAttrs('exitAbyss')} title="Return to Dark City">
            <div style="position:relative;display:inline-block">
            ...
            <div style="text-align:center;margin-top:5px;font-size:11px;font-weight:600;color:#e74c3c;text-shadow:0 1px 3px rgba(0,0,0,0.9);white-space:nowrap">← Exit</div>
            <div style="font-size:10px;color:rgba(231,76,60,0.7);text-align:center">Dark City</div>
        </div>
    ` : '';
