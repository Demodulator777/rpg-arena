...
function renderForge() {
    ...
    const weaponHtml = weave ? `
        <div class="forge-card" id="weapon-upgrade-card" style="margin-bottom:20px;border-color:#f1c40f44;display:flex;align-items:center;gap:12px;padding:12px 16px;cursor:pointer">
    ...
    const upgradeCard = document.getElementById('weapon-upgrade-card');
    if (upgradeCard) upgradeCard.addEventListener('click', openWeaponUpgrade);
}
