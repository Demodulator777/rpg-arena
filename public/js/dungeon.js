// ============================================================
//  dungeon.js  вЂ“  Battle Arena Dungeon System
...
(function (global) {
  ...
  // в”Ђв”Ђ API Wrapper (uses your existing api function) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // в”Ђв”Ђ Dungeon Visuals в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  // в”Ђв”Ђ Adventurer's Guild в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
const GUILD_EXCHANGES = [
  { id: 'exchange_gold', name: 'Exchange Dungeon Gold', icon: 'рџ’°', 
    cost: { dungeonGold: 100 }, reward: { gold: 80, reputation: 1 },
    desc: 'Convert 100 dungeon gold into 80 real gold + 1 reputation point' },
  
  { id: 'exchange_materials', name: 'Material Bounty', icon: 'рџ“¦', 
    cost: { crypt_dust: 10, void_shard: 5 }, reward: { gold: 200, reputation: 2 },
    desc: 'Trade 10 Crypt Dust and 5 Void Shards for 200 gold' },
  
  { id: 'exchange_rare', name: 'Rare Material Bounty', icon: 'вњЁ', 
  ...
  { id: 'exchange_legendary', name: 'Legendary Exchange', icon: 'рџ‘‘', 
...
// guildReputation: 0,
  ...
  // в”Ђв”Ђ Infinite Floor Tower в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  const DUNGEON = { id:'tower', name:'The Endless Tower', icon:'рџ—ј', desc:'An infinite tower of darkness. Clear each floor to ascend.' };
  ...
  // в”Ђв”Ђ Mini-Boss Pool (costs 5-10 tokens) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
const MINI_BOSS_POOL = [
    { name:'Shadow Stalker',     icon:'рџђє', baseHp:400, baseAtk:55, baseDef:25, tokenCost:5,  minFloor:10, image:'/images/dungeon/miniboss1.jpg' },
    { name:'Crystal Golem',      icon:'рџ’Ћ', baseHp:600, baseAtk:40, baseDef:45, tokenCost:6,  minFloor:15, image:'/images/dungeon/miniboss2.jpg' },
    { name:'Flame Revenant',     icon:'рџ”Ґ', baseHp:350, baseAtk:70, baseDef:20, tokenCost:7,  minFloor:20, image:'/images/dungeon/miniboss3.jpg' },
    { name:'Frost Wyrmling',     icon:'вќ„пёЏ', baseHp:450, baseAtk:60, baseDef:30, tokenCost:8,  minFloor:25, image:'/images/dungeon/miniboss4.jpg' },
    { name:'Void Stalker',       icon:'рџЊ‘', baseHp:500, baseAtk:75, baseDef:28, tokenCost:9,  minFloor:30, image:'/images/dungeon/miniboss5.jpg' },
    { name:'Doom Knight',        icon:'вљ”пёЏ', baseHp:700, baseAtk:65, baseDef:50, tokenCost:10, minFloor:35, image:'/images/dungeon/miniboss6.jpg' },
];
...
function getMiniBossForFloor(floor) {
  ...
  const MONSTER_POOL = [
    { id:'skeleton',    name:'Skeleton Warrior', icon:'рџ’Ђ', hp:80,  atk:12, def:5,  steal:true,  minFloor:1  },
    { id:'ghost',       name:'Wailing Ghost',    icon:'рџ‘»', hp:60,  atk:18, def:2,  steal:false, minFloor:1  },
    { id:'zombie',      name:'Rotting Zombie',   icon:'рџ§џ', hp:120, atk:8,  def:8,  steal:true,  minFloor:1  },
    { id:'lich',        name:'Lich Apprentice',  icon:'рџ§™', hp:70,  atk:22, def:3,  steal:false, minFloor:3  },
    { id:'fire_imp',    name:'Fire Imp',         icon:'рџ€', hp:90,  atk:20, def:6,  steal:false, minFloor:3  },
    { id:'lava_golem',  name:'Lava Golem',       icon:'рџ—ї', hp:180, atk:14, def:22, steal:false, minFloor:5  },
    { id:'salamander',  name:'Fire Salamander',  icon:'рџ¦Ћ', hp:110, atk:25, def:8,  steal:true,  minFloor:5  },
    { id:'pyromancer',  name:'Pyromancer Shade', icon:'рџ”Ґ', hp:85,  atk:32, def:4,  steal:false, minFloor:7  },
    { id:'void_wraith', name:'Void Wraith',      icon:'рџЊ‘', hp:130, atk:38, def:10, steal:true,  minFloor:8  },
    { id:'abyssal_eye', name:'Abyssal Eye',      icon:'рџ‘ЃпёЏ', hp:100, atk:45, def:5,  steal:false, minFloor:10 },
    { id:'shadow_lord', name:'Shadow Lord',      icon:'рџ•·пёЏ', hp:200, atk:30, def:28, steal:true,  minFloor:12 },
    { id:'void_titan',  name:'Void Titan',       icon:'рџ’ ', hp:250, atk:42, def:35, steal:true,  minFloor:15 },
    { id:'dread_knight',name:'Dread Knight',     icon:'вљ”пёЏ', hp:300, atk:50, def:40, steal:true,  minFloor:20 },
    { id:'elder_lich',  name:'Elder Lich',       icon:'рџ’њ', hp:220, atk:60, def:20, steal:false, minFloor:25 },
    { id:'shadow_stalker', name:'Shadow Stalker', icon:'рџђє', hp:400, atk:55, def:25, steal:true, minFloor:10, isMiniBoss: true, tokenCost: 5 },
    { id:'crystal_golem', name:'Crystal Golem', icon:'рџ’Ћ', hp:600, atk:40, def:45, steal:false, minFloor:15, isMiniBoss: true, tokenCost: 6 },
    { id:'flame_revenant', name:'Flame Revenant', icon:'рџ”Ґ', hp:350, atk:70, def:20, steal:false, minFloor:20, isMiniBoss: true, tokenCost: 7 },
    { id:'frost_wyrmling', name:'Frost Wyrmling', icon:'вќ„пёЏ', hp:450, atk:60, def:30, steal:true, minFloor:25, isMiniBoss: true, tokenCost: 8 },
    { id:'void_stalker', name:'Void Stalker', icon:'рџЊ‘', hp:500, atk:75, def:28, steal:true, minFloor:30, isMiniBoss: true, tokenCost: 9 },
    { id:'doom_knight', name:'Doom Knight', icon:'вљ”пёЏ', hp:700, atk:65, def:50, steal:true, minFloor:35, isMiniBoss: true, tokenCost: 10 },
  ];

const BOSS_POOL = [
    { name:'Death Knight Malachar', icon:'вљ”пёЏрџ’Ђ', image:'/images/boss/malachar.jpg', baseHp:600,  baseAtk:45, baseDef:20, steal:true  },
    { name:'Ignarath the Eternal',  icon:'рџЊ‹рџ”Ґ', image:'/images/boss/ignarath.jpg',  baseHp:700,  baseAtk:55, baseDef:25, steal:false },
    { name:'Nyxaroth the Devourer', icon:'рџЊ‘рџ‘ЃпёЏ', image:'/images/boss/nyxaroth.jpg',  baseHp:800,  baseAtk:65, baseDef:30, steal:true  },
    { name:'The Hollow King',       icon:'рџ‘‘рџ’Ђ', image:'/images/boss/hollowking.jpg', baseHp:900,  baseAtk:70, baseDef:35, steal:true  },
    { name:'Voidborn Colossus',     icon:'рџ’ рџЊ‘', image:'/images/boss/voidborn.jpg',   baseHp:1000, baseAtk:80, baseDef:40, steal:false },
    { name:'The Undying Empress',   icon:'рџ‘ёрџ”Ґ', image:'/images/boss/empress.jpg',    baseHp:1100, baseAtk:90, baseDef:45, steal:true  },
    { name:'Abyssal Sovereign',     icon:'рџЊЉрџ’Ђ', image:'/images/boss/sovereign.jpg',  baseHp:1200, baseAtk:95, baseDef:50, steal:true  },
];
...
function getBossForFloor(floor) {
  ...
  // в”Ђв”Ђ Loot Tables в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  const MINION_LOOT = [
    { type:'gold',       weight:75, min:5,  max:40  },
    { type:'potion_hp',  weight:15, name:'Health Potion',  icon:'рџ§Є', heal:50  },
    { type:'potion_mp',  weight:5, name:'Mana Potion',    icon:'рџ’§', mp:30    },
    { type:'item_common',weight:5 },
  ];

  const COMMON_ITEMS = [
    { name:'Iron Shard',       icon:'рџ”©', type:'material', rarity:'common' },
    { name:'Bone Fragment',    icon:'рџ¦ґ', type:'material', rarity:'common' },
    { name:'Dim Crystal',      icon:'рџ’Ћ', type:'material', rarity:'common' },
    { name:'Frayed Cloth',     icon:'рџ§µ', type:'material', rarity:'common' },
    { name:'Tarnished Coin',   icon:'рџЄ™', type:'material', rarity:'common' },
  ];
...
async function refreshCharacter() {
  ...
  // в”Ђв”Ђ Token Economy в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
    ...
    apiFetch('POST', '/game/dungeon/mp-spent', { mpSpent })
      .then(response => {
        if (response && response.totalTokens !== undefined) {
          ...
          updateTokenDisplay();
          saveState();
          log(`вљ—пёЏ Gained ${response.tokensEarned} Boss Clearance Token${response.tokensEarned > 1 ? 's' : ''} from MP spent.`, 'log-token');
        }
      })
  ...
  // в”Ђв”Ђ Map Generation в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
function generateFloor(dungeonId, floor) {
    ...
    while (chosen.length < ROOMS_PER_FLOOR && frontier.length > 0) {
      let current;
      if (frontier.length === 1) {
        current = frontier[0];
      } else if (Math.random() < 0.35) {
        current = frontier[rand(0, frontier.length - 1)];
      } else if (Math.random() < 0.6) {
        current = frontier[Math.max(0, frontier.length - 1 - rand(0, Math.min(4, frontier.length - 1)))];
      } else {
      ...
      if (!neighbors.length) {
        const deadIdx = frontier.indexOf(current);
        if (deadIdx >= 0) frontier.splice(deadIdx, 1);
        continue;
      }
      ...
      if (neighbors.length <= 1 && Math.random() < 0.65) {
        const trimIdx = frontier.indexOf(current);
        if (trimIdx >= 0) frontier.splice(trimIdx, 1);
      }
    }
  ...
  // в”Ђв”Ђ Combat Engine в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
function rollBossLoot(bossDef) {
  ...
  const premiumFeatures = [
    { id: 'arcane_reservoir', name: 'Arcane Reservoir', emoji: 'рџ”®', desc: '2Г— max MP and 2Г— MP regen' },
    { id: 'warlord', name: 'Warlord', emoji: 'вљ”пёЏ', desc: '+15% damage and +10% hit chance' },
    { id: 'iron_fortress', name: 'Iron Fortress', emoji: 'рџЏ°', desc: '+10% agility and +15% armor' },
    { id: 'apprentice', name: 'Apprentice', emoji: 'рџ“љ', desc: 'All upgrade costs reduced by 20%' },
    { id: 'vault_keeper', name: 'Vault Keeper', emoji: 'рџЏ¦', desc: 'Lose only 5% gold on PvP defeat' },
    { id: 'fortune_hunter', name: 'Fortune Hunter', emoji: 'рџ’°', desc: '+30% gold from missions, cooldowns 50% shorter' }
  ];
  ...
  // в”Ђв”Ђ Apply Loot (Syncs with server) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  if (loot.type === 'gold') {
    ...
    log(`рџ’° Found ${loot.amount} dungeon gold`, 'log-loot');
    ...
    log(`рџ§Є Found ${loot.name}`, 'log-loot');
  } 
...
function enterDungeon(dungeonId) {
    ...
    if (D.savedProgress['tower']) {
        ...
        log(`рџ”® Resuming Floor ${D.floor}...`, 'log-enter');
        renderDungeonView();
        return;
    }

    // в”Ђв”Ђ Fresh run вЂ” start from the player's current floor (loaded from DB) в”Ђв”Ђ
    D.activeDungeon = 'tower';
    ...
    log(`вљ”пёЏ Entered The Endless Tower вЂ“ Floor ${startFloor}`, 'log-enter');
    renderDungeonView();
}
...
function travelToRoom(targetIdx) {
    ...
    if (hasAliveMonsters && !hasEvaded) {
        log(`вљ пёЏ You must defeat or escape from the ${current.monsters.length} enemies in this room before leaving!`, 'log-danger');
        return;
    }
    ...
    log(`рџљ¶ Traveling to Room ${targetIdx + 1}...`, 'log-travel');
    ...
    D.travelTimer = setTimeout(() => {
        ...
        log(`рџ“Ќ Arrived at ${target.isBoss ? 'вљ пёЏ BOSS ROOM' : target.type === 'treasure' ? 'рџ’° Treasure Room' : `Room ${targetIdx+1}`}`, 'log-arrive');
...
function initiateFight(roomIdx) {
    ...
    if (!anyAlive) {
        ...
        log(`рџ’¤ Monsters respawn in ${hoursLeft}h`, 'log-info');
        return;
    }
...
function fightRound() {
    ...
    log(`вњ… ${defeatedMonster.name} defeated!`, 'log-success');
...
function tryRun(roomIdx) {
    if (chance(RUN_ESCAPE_CHANCE)) {
        log(`рџ’Ё Escaped successfully!`, 'log-success');
        ...
        log(`вљ пёЏ Failed to escape! The monsters attack!`, 'log-danger');
        const c = getChar();
        if (c && D.combat && D.combat.monsters && D.combat.monsters.length > 0) {
            ...
            for (let i = 0; i < D.combat.monsters.length; i++) {
                ...
                if (m.currentHp > 0) {
                    ...
                    totalDamage += mDmg;
                    log(`рџ’Ґ ${m.name} hits you for ${mDmg}!`, 'log-danger');
                }
            }
...
function tryStealFromPlayer(roomIdx, monsterIndex) {
    ...
    log(`рџ’° ${D.combat.monsters[monsterIndex].name} stole your ${stolen.name}!`, 'log-danger');
}
  ...
  function onMonsterDefeated(roomIdx) {
    ...
    if (room.monster.stolenItems && room.monster.stolenItems.length > 0) {
      ...
      log(`рџЋ’ Recovered stolen items: ${recovered.map(i=>i.name).join(', ')}!`, 'log-success');
    }

    const loot = rollMinorLoot(D.activeDungeon);
    applyLoot(loot);

    log(`вњ… ${room.monster.name} defeated!`, 'log-success');
    D.combat = null;
    saveState();
    saveProgressToDB();
    renderDungeonView();
  ...
  function onPlayerDeath() {
    log(`рџ’Ђ You have been slain! Progress saved.`, 'log-danger');
    const c = getChar();
...
async function fightBoss(roomIdx) {
    ...
    if (!success) {
      log(`рџ—ќпёЏ Need ${TOKENS_PER_RUN} tokens to challenge the boss. You have ${D.tokens}.`, 'log-danger');
      return;
    }
...
function onBossDefeated() {
  ...
  log(`рџЏ† FLOOR ${D.floor} CLEARED! ${boss.name} vanquished!`, 'log-boss');
  log(`рџ’° Loot: ${loot.gold} gold | рџ’Ћ ${loot.gems} gems | вњЁ ${loot.premium.name} (${loot.premium.days} days)`, 'log-success');
                ...
                <div class="dungeon-wrapper">
                    <div class="dungeon-topbar">
                        <div class="dungeon-title-wrap">
                            <span class="dungeon-title-icon">вљ”пёЏ</span>
                            <div>
                        ...
                        <div class="dungeon-token-wrap" style="display: flex; gap: 12px;">
                            <div class="dungeon-token-pill">
                                <span class="dungeon-token-icon">рџ—ќпёЏ</span>
                            ...
                            <div class="dungeon-token-pill" style="background: rgba(241,196,15,0.1); border-color: rgba(241,196,15,0.3);">
                                <span class="dungeon-token-icon">рџ’°</span>
                                <span>Dungeon Gold:</span>
                                <span id="dungeon-gold-count" class="dungeon-token-num">${D.dungeonGold || 0}</span>
                            </div>
                        </div>
                        <div class="dungeon-token-hint">20 MP spent = 1 Token В· ${TOKENS_PER_RUN} Tokens per boss</div>
                    </div>
...
function renderDungeonRaidHub(guildData) {
    ...
    const raidCooldownRemaining = globalCooldownUntil > now ? (globalCooldownUntil - now) : 0;
    ...
    const raidCards = raids.length ? raids.map(raid => {
      ...
      `).join('');
      const rewardBits = [];
      if (raid.reward?.gold) rewardBits.push(`Gold ${Number(raid.reward.gold).toLocaleString()}`);
      if (raid.reward?.gems) rewardBits.push(`Gems ${Number(raid.reward.gems).toLocaleString()}`);
      if (raid.reward?.item?.itemData?.name) rewardBits.push(`Chest ${raid.reward.item.itemData.name}`);
      ...
      return `
        <div class="exchange-card exchange-available raid-card raid-status-${raid.status}">
          ...
          <div class="exchange-info">
            ...
            <div class="exchange-desc">Six-player cap. Party stats merge into one strike against a floor-scaled raid boss.</div>
            ...
            ${rewardBits.length ? `<div class="exchange-reward"><span class="reward-item">Reward: ${rewardBits.join(' � ')}</span></div>` : ''}
            ${resultLog}
      ...
      `;
    }).join('') : '<div class="exchange-card exchange-unavailable"><div class="exchange-info"><div class="exchange-name">No active raids yet</div><div class="exchange-desc">Once an Apprentice posts a raid, it will appear here for the whole server.</div></div></div>';

    return `
      <div class="dungeon-floor-history dungeon-raid-hub-shell">
        <div class="dungeon-raid-hub-head">
          <div class="dungeon-raid-hub-title">Raids</div>
          <div class="dungeon-raid-hub-subtitle">Guild operations open to Apprentice leaders and any joining members.</div>
        </div>
        ${raidCooldownRemaining > 0 ? `<div class="rep-bar-text" style="margin-bottom:10px">Raid recovery active: ${formatRaidDuration(raidCooldownRemaining)} remaining.</div>` : ''}
        ${canCreateRaid ? `
          <div class="exchange-card exchange-available raid-create-card">
            <div class="exchange-icon raid-card-icon">Raid</div>
            <div class="exchange-info">
              <div class="exchange-name">Create a Raid</div>
              <div class="exchange-desc">Choose any floor up to your highest cleared dungeon floor. Auto-start can wait for a full party or a schedule.</div>
        ...
        ` : `<div class="exchange-card exchange-unavailable"><div class="exchange-info"><div class="exchange-name">Raids unlock at Apprentice</div><div class="exchange-desc">Reach ${apprenticeReq} guild reputation to create raids. You can still join raids listed below.</div></div></div>`}
...
const previewFloors = [0,1,2,3,4].map(offset => {
    ...
    return `<div class="dungeon-floor-preview-card" style="border-color:${t.theme}55">
        ...
        <div style="font-size:0.6rem;color:var(--dungeon-muted)">вќ¤пёЏ${boss.hp}</div>
    </div>`;
}).join('');
    ...
    area.innerHTML = `
      <div class="dungeon-tower-entry" style="--dtheme:${nextTheme.theme};--dglow:${nextTheme.themeGlow}">
        <div class="dungeon-tower-top">
          <div class="dungeon-tower-icon">рџ—ј</div>
          <div class="dungeon-tower-info">
            ...
            <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:8px;font-size:0.78rem;color:var(--dungeon-muted)">
              <span>рџЏ† Your best: <strong style="color:var(--dungeon-text)">Floor ${highFloor}</strong></span>
              <span>рџ—ќпёЏ <strong style="color:var(--dungeon-token)">${D.tokens}</strong> tokens В· ${TOKENS_PER_RUN} per boss</span>
              ${hasSave ? `<span class="dungeon-save-badge">рџ“Њ Saved on Floor ${curFloor}</span>` : ''}
            </div>
          </div>
        </div>
...
<div style="display:flex;align-items:center;gap:14px;flex-wrap:wrap">
    ...
    <div>
        ...
        <div style="font-size:0.75rem;color:var(--dungeon-muted);margin-top:2px">
            вќ¤пёЏ ${nextBoss.hp} HP В· вљ”пёЏ ${nextBoss.atk} ATK В· рџ›ЎпёЏ ${nextBoss.def} DEF
        </div>
        <div style="font-size:0.72rem;color:var(--dungeon-gold);margin-top:4px">
            Drops: рџ’°${nextLoot.gold[0]}вЂ“${nextLoot.gold[1]} В· рџ’Ћ${nextLoot.gems[0]}вЂ“${nextLoot.gems[1]} В· вњЁ Random Premium (${nextLoot.premiumDays[0]}вЂ“${nextLoot.premiumDays[1]} days)
        </div>
    </div>
</div>
        </div>
        ...
        ${hasAnyProgress ? 'рџ”® Resume Delve (Floor '+curFloor+')' : 'вљ”пёЏ Begin the Ascent'}
    </button>
      </div>

      <div class="dungeon-floor-history">
        <div style="font-size:0.7rem;color:var(--dungeon-muted);text-transform:uppercase;letter-spacing:0.08em;margin-bottom:10px">рџ“€ Upcoming floors</div>
      ...
      <div id="dungeon-raid-hub" class="dungeon-floor-history dungeon-raid-hub-shell">
        ...
        <div class="rep-bar-text">Loading raids...</div>
      </div>
    `;
    ...
    apiFetch('GET', '/game/dungeon/guild').then(guildData => {
      ...
      if (raidHub) {
        raidHub.innerHTML = `
          ...
          <div class="rep-bar-text">Raid hub failed to load. Check the latest server routes.</div>
        `;
      }
    });
  }
...
function renderRoomInfo(room) {
        ...
        return `
            <div class="dungeon-boss-room">
                ...
                <div class="boss-stats">
                    вќ¤пёЏ ${boss.hp} HP В· вљ”пёЏ ${boss.atk} ATK В· рџ›ЎпёЏ ${boss.def} DEF
                </div>
                <div class="boss-drop-preview">
                    Drops: рџ’°${boss.loot.gold[0]}-${boss.loot.gold[1]} gold В· рџ’Ћ${boss.loot.gems[0]}-${boss.loot.gems[1]} gems В· вњЁ Random Premium Feature (${boss.loot.premiumDays[0]}-${boss.loot.premiumDays[1]} days)
                </div>
                <button class="dungeon-btn dungeon-btn-fight boss-fight-btn" ${actionAttrs('dungeonFightBoss', room.id)}>
                    вљ”пёЏ Challenge Boss (${TOKENS_PER_RUN} Tokens Required)
                </button>
            </div>
        `;
    }
    ...
    if (room.isMiniBoss && anyMonsterAlive) {
        ...
        return `
            <div class="dungeon-room-monster">
                <div class="monster-icon">вљ пёЏ ${m.icon}</div>
                <div class="monster-info">
                    ...
                    <div class="monster-stats">вќ¤пёЏ ${m.currentHp}/${m.maxHp} В· вљ”пёЏ ${m.atk} В· рџ›ЎпёЏ ${m.def} В· рџ—ќпёЏ Costs ${m.tokenCost} tokens</div>
                </div>
                <div class="monster-btns">
                    <button class="dungeon-btn dungeon-btn-fight" ${actionAttrs('dungeonFightMiniBoss', room.id)}>вљ”пёЏ Challenge Mini-Boss</button>
                </div>
            </div>
        `;
    }
    ...
    if (anyMonsterAlive) {
        ...
        return `
            <div class="dungeon-room-monster">
                <div class="monster-icon">${monsterCount > 1 ? `рџ‘Ґ ${monsterCount}x` : m.icon}</div>
                <div class="monster-info">
                    ...
                    <div class="monster-stats">
                        ${monsterCount > 1 ? `${aliveCount} enemies remaining` : `вќ¤пёЏ ${m.currentHp}/${m.maxHp} В· вљ”пёЏ ${m.atk} В· рџ›ЎпёЏ ${m.def}`}
                        ${m.steal && monsterCount === 1 ? 'В· рџЋ’ Can steal' : ''}
                    </div>
                    ${monsterCount > 1 ? `<div class="monster-warning" style="font-size:0.65rem;color:#e74c3c;margin-top:4px">вљ пёЏ All enemies attack together each round!</div>` : ''}
                </div>
                <div class="monster-btns">
                    <button class="dungeon-btn dungeon-btn-fight" ${actionAttrs('dungeonFight', room.id)}>вљ”пёЏ Fight</button>
                    <button class="dungeon-btn dungeon-btn-run" ${actionAttrs('dungeonRun', room.id)}>рџ’Ё Run (75%)</button>
                </div>
                ${m.stolenItems && m.stolenItems.length > 0 ? `
                    <div class="stolen-items-notice">
                        рџЋ’ Carrying stolen items: ${m.stolenItems.map(i=>i.name).join(', ')}
                    </div>` : ''}
            </div>
        `;
    }
    ...
    if (allMonstersRespawning && room.monsters && room.monsters[0]) {
        ...
        return `
            <div class="dungeon-room-clear">
                <div style="color:var(--dungeon-muted);font-size:0.9rem">рџ’¤ ${monsterCount} monster${monsterCount > 1 ? 's' : ''} respawn${monsterCount > 1 ? '' : 's'} in ${hoursLeft}h</div>
                ${room.type === 'treasure' ? '<div style="color:#f1c40f;margin-top:8px">рџ’° Treasure already looted</div>' : ''}
            </div>
        `;
    }
    ...
    return `
        <div class="dungeon-room-clear">
            <div style="color:var(--dungeon-muted)">
                ${room.isStart ? 'рџљЄ Dungeon Entrance вЂ” choose a path to explore.' :
                    room.type === 'treasure' ? (room.looted ? 'рџ’° Treasure already collected.' : 'вњЁ Peaceful chamber. Treasure collected!') :
                    'рџЏљпёЏ Empty corridor. All clear.'}
            </div>
        </div>
    `;
}
        ...
        return `
            <div class="combat-monster-entry ${isCurrent ? 'current-target' : ''} ${isDead ? 'defeated' : ''}" style="margin-bottom:8px;padding:6px;border-radius:6px;background:${isCurrent ? 'rgba(255,255,255,0.1)' : 'transparent'}">
                <div style="display:flex;align-items:center;gap:8px">
                    <span class="fighter-icon" style="font-size:1.2rem">${isDead ? 'рџ’Ђ' : m.icon}</span>
                    <div style="flex:1">
    ...
    overlay.innerHTML = `
        ...
        <div class="dungeon-overlay-card dungeon-combat-panel" style="--dtheme:${def.theme};--dglow:${def.themeGlow}">
            <div class="combat-header">
                ${currentMonster.isBoss ? `<div class="combat-boss-warning">вљ пёЏ BOSS BATTLE</div>` : ''}
                <div class="combat-title">вљ”пёЏ Combat: ${monsters.length} Enemies</div>
            </div>

            <div class="combat-fighters">
                <div class="combat-fighter player-fighter">
                    <div class="fighter-icon">рџ§™</div>
            ...
            <div class="combat-actions">
                <button class="dungeon-btn dungeon-btn-fight" ${actionAttrs('dungeonAttack')}>вљ”пёЏ Strike</button>
                <button class="dungeon-btn dungeon-btn-run" ${actionAttrs('dungeonRunCombat')}>рџ’Ё Flee (75%)</button>
            </div>
        </div>
    `;
}
  ...
  modal.innerHTML = `
    <div class="modal-box dungeon-victory-box">
      ...
      <div class="victory-loot">
        <div class="loot-row">рџ’° <strong>${loot.gold.toLocaleString()}</strong> Gold</div>
        <div class="loot-row">рџ’Ћ <strong>${loot.gems}</strong> Gems</div>
        <div class="loot-row premium-reward">
          вњЁ <strong>${loot.premium.emoji} ${loot.premium.name}</strong> (${loot.premium.days} days)
...
function claimGuildBounty() {
  ...
  async function fightMiniBoss(roomIdx) {
    ...
    if (D.tokens < miniBoss.tokenCost) {
        log(`рџ—ќпёЏ Need ${miniBoss.tokenCost} tokens to challenge this mini-boss. You have ${D.tokens}.`, 'log-danger');
        return;
    }
  ...
  // в”Ђв”Ђ CSS Loading в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
  ...
  function refreshRaidUi() {
    if (document.getElementById('dungeon-raid-hub')) renderDungeonList();
    else renderGuild();
  }
      ...
      const guildHtml = `
        <div class="guild-container">
          ...
          <div class="guild-stats">
            ...
            <div class="guild-stat-card">
              <div class="guild-stat-icon">Rep</div>
              <div class="guild-stat-info">
          ...
          <div class="guild-reputation-bar">
            <div class="rep-bar-label">Guild notice</div>
            <div class="rep-bar-text">Open the Dungeon tab landing screen to create, join, and claim raids.</div>
          </div>
          <button class="dungeon-btn" ${actionAttrs('closeGuild')} style="width:100%;margin-top:20px">Continue Exploring</button>
        </div>
      `;
      if (overlay) {
        overlay.innerHTML = `<div class="dungeon-overlay-backdrop" ${actionAttrs('closeGuild')}></div><div class="dungeon-overlay-card guild-overlay-card">${guildHtml}</div>`;
      } else if (area) {
  ...
  // в”Ђв”Ђ Global API (called from HTML onclick) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
global.dungeonRun = (roomIdx) => {
    ...
    if (room && room.monsters && room.monsters.length > 0) {
        ...
        const anyAlive = room.monsters.some(m => !m.lastKilled || elapsed(m.lastKilled, MONSTER_RESPAWN_H));
        if (!anyAlive) {
            log(`рџ’¤ All monsters are dead or respawning.`, 'log-info');
            return;
        }
